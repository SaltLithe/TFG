...
public enum ObserverActions {
	...
	SET_CHOSEN_NAME, CLOSE_ALL_TABS, UPDATE_HIGHLIGHT, DISABLE_TEXT_EDITOR, DISABLE_SAVE_BUTTONS, DISABLE_RUN_CONFIG, CLEAR_CONSOLE, CLOSE_SINGLE_TAB, FULL_SET_TEXT
