...
public enum ObserverActions {
	...
	SAFETY_SAVE, SAFETY_DELETE, SAFETY_STOP,SET_SAVE_FLAG_TRUE, SET_SAVE_FLAG_FALSE, SAVE_FULL, DELETE_PROJECT_TREE, DELETE_CLASS_PATH, DELETE_CLASS_PATH_FOCUSED
