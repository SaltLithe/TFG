			...
			browseButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent arg0) {
					 ...
					 JFileChooser chooser = new JFileChooser(); 
					    ...
					    if (chooser.showOpenDialog(DeveloperMainFrameWrapper.getInstance()) == JFileChooser.APPROVE_OPTION) { 
					    
					       File directory =  chooser.getSelectedFile();
					       if(directory.exists()) {
					    	   
					    	   pathField.setText(directory.getAbsolutePath());
					    	   UIController.getInstance().getDeveloperComponent().expectedWorkSpaceLocation = directory.getAbsolutePath();
