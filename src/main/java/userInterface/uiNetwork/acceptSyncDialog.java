				...
				public void actionPerformed(ActionEvent arg0) {
					...
					if (chooser
						...
						if (directory.exists()) {
							...
							CommandController.getInstance().getDeveloperComponent().expectedWorkSpaceLocation = directory
									.getAbsolutePath();
				...
				okButton.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent arg0) {
						...
						if (pathField.getText() != "" && pathField.getText() != null) {
							...
							CommandController.developerComponent.sendMessageToServer(message);
